...
class AuctionsControllerTest < ActionController::TestCase
  ...
  test "should create auction" do
    assert_difference('Auction.count') do
      post :create, auction: { item_id: @auction.item_id, max_bid: @auction.max_bid, user_id: @auction.user_id }
    end
  ...
  test "should update auction" do
    put :update, id: @auction, auction: { item_id: @auction.item_id, max_bid: @auction.max_bid, user_id: @auction.user_id }
    assert_redirected_to auction_path(assigns(:auction))
  end
